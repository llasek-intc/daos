...
enum daos_media_type_t {
	DAOS_MEDIA_SCM	= 0,
	DAOS_MEDIA_NVME_TIER0 = 1,
	DAOS_MEDIA_NVME = DAOS_MEDIA_NVME_TIER0,
	DAOS_MEDIA_NVME_TIER1,
	DAOS_MEDIA_NVME_PERF = DAOS_MEDIA_NVME_TIER1,
	DAOS_MEDIA_NVME_TIER2,
	DAOS_MEDIA_NVME_TIER3,
	DAOS_MEDIA_MAX_NVME = DAOS_MEDIA_NVME_TIER3,
	DAOS_MEDIA_MAX
};
